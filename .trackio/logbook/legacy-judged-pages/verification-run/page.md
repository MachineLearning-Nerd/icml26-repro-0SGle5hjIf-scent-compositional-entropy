...
---
<!-- trackio-cell
{"type": "code", "id": "cell_6f56447f1431", "created_at": "2026-07-21T17:01:17+00:00", "title": "verify all claims", "command": [".venv/bin/python", "repro/src/verify_scent.py"], "exit_code": 0, "duration_s": 0.173}
-->
````bash
$ .venv/bin/python repro/src/verify_scent.py
````

exit 0 · 0.2s


````python title=verify_scent.py
...
==============================================================================
CLAIM 1: SCENT dual update ν_t = ν_{t-1} + log(1 + α e^{s-ν}) is closed-form
==============================================================================
  dual ν finite (True), changed from init (True)
  ν range: [3.3742, 4.3557]
  -> PASS

==============================================================================
CLAIM 2 (Theorem 3.6): SCENT converges at O(1/sqrt(T))
==============================================================================
